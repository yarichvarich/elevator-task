...
export class CapacitySelector extends Container {
  ...
  constructor() {
    ...
    this.labelText = new Text({
      text: this._capacityConfig.capacity.toString(),
      style,
    });
  ...
  public get value() {
    return this._capacityConfig.capacity;
  }
  public set value(v: number) {
    if (v < this._capacityConfig.minCapacity)
      v = this._capacityConfig.minCapacity;
    if (v > this._capacityConfig.maxCapacity)
